...
The "@Environment@":http://download.eclipse.org/ocl/javadoc/6.4.0/org/eclipse/ocl/Environment.html interface has a generic type signature with several parameters, representing the metamodeling
